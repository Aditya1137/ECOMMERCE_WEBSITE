    ...
    <nav class="navbar text-white" style="background-color: black;">
        <div class="container-fluid">
            <a class="navbar-brand">
                <img src="images/butter.jpg" alt="" style="width:100px; height:50px;"> 
            </a>
            <div>
                <a href="index.php" class="text-primary text-decoration-none fs-6 pe-3"><i class="ri-home-8-line"></i>HOME</a>                <a href="viewcart.php" class="text-warning text-decoration-none fs-6 pe-2 ">
                    <i class="ri-shopping-cart-2-line"></i>CART ( <?php echo $count; ?> )</a>
                <span class="text-primary text-decoration-none fs-6 pe-3">
                    <i class="ri-user-3-fill"></i>Hello,
                    <?php
                    if (isset($_SESSION['user'])) {
                        echo $_SESSION['user'];
                        echo "
                        <a href='form/logout.php' class='text-primary text-decoration-none fs-6 pe-3'>
                        <i class='ri-login-box-line'></i>Login</a>";
                    }
                    else{
                        echo "
                        <a href='form/login.php' class='text-primary text-decoration-none fs-6 pe-3'>
                        <i class='ri-login-box-line'></i>Login</a>";
                    }
                    ?> 
                    <a href="../admin/mystore.php" class="text-primary text-decoration-none fs-6">ADMIN</a>
                </span>
            </div>
        </div>
    </nav>
