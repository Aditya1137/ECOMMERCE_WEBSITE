...
<body class="bg-white">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12 bg-warning mb-4 text-center w-25 rounded">
                <h1 class="text-dark" style="">My Cart</h1>
            </div>
        </div>
    </div>
    <div class="container-fluid ">
        <div class="row justify-content-center">
                        ...
                        if (isset($_SESSION['cart'])) {
                            ...
                            foreach ($_SESSION['cart'] as $key => $value) {
                                ...
                                echo "
                                    ...
                                    <td>$ptotal</td>
                                    <td><button name='update' class='btn-dark'>Update</button></td>
                                    <td><button name='remove' class='btn-dark'>Delete</button></td>
            ...
            <div class="col-lg-3 text-center">
                <h4 class="bg-dark text-primary">Total</h4>
                <h2 class="bg-dark text-primary"><?php echo number_format($total,2);?></h2>
            </div>
        </div>
    </div>
