...
<body>
    <div class="main-container" style="background-color:blue">
        <div class="container ">
            <div class="row justify-content-center">
                <div class="col-md-6 mt-5 font-monospace border border-info my-5"
                    style="border-radius:15px; background-color:transparent;box-shadow:4px 2px 20px white,4px 2px 20px white;">
                    <p class="text-white fs-3 text-center fw-bold my-3">User Login</p>
                    <form class="form" action="login1.php" method="post">
                        
                        <div class="mb-3">
                            <label for="" class="text-white">Email</label>
                            <input type="text" name="Email" placeholder="Enter Your Email or Number" class="form-control">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3 d-flex justify-content-center">
                            <a href="register.php" class="btn w-75 bg-dark text-white" name="submit">Don't have Account ? Register</a>
                        </div>
                    </form>
                </div>
            </div>
