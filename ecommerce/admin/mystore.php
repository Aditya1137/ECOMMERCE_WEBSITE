...
<body>
    ...
    <nav class="navbar bg-primary py-2 navbar-light">
    ...
    <div class=" col-md-6 bg-primary text-center m-auto py-1">
        <a href="product/index.php" class="mx-5 fs-4 text-white text-decoration-none fw-bold">Add Post</a>
        <a href="" class="mx-5 fs-4 text-white text-decoration-none fw-bold">Users</a>
    </div>
